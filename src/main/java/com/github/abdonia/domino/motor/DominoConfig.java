 ...
 * setar suas {@linkplain Class classes} ou o {@linkplain Class#getName() nome
 * qualificado de suas classes}. Pra jogadores também é possível setar uma
 * instância diretamente. Por exemplo, o jogador 0 da dupla 1 pode ser setado
 * das seguinte maneiras:</p>
 *
 * <pre>
 * {@code
 ...
 * pela existência da classe cujo nome foi passado na opção <em>(3)</em> Só
 * ocorrera {@linkplain Jogo#Jogo(DominoConfig) quando a configuração for usada
 * pra se criar um Jogo}.</p>
 *
 * @author Bruno Abdon
 */
