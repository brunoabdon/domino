...
public interface DominoEventListener {
	 ...
	 */
	public default void partidaComecou(int placarDupla1, int placarDupla2, boolean ehDobrada){
	 ...
	 */
	public default void jogadorJogou(String nomeDoJogador, Lado lado, Pedra pedra){
